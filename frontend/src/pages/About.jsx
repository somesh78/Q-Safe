...
export default function About() {
  ...
  const team = [
    {
      role: 'Security',
      description: 'Focused on cryptography best practices and keeping your data protected at every layer.'
    },
    {
      role: 'Development',
    ...
    {
      role: 'Support',
      description: 'Responsive team ready to help with technical issues and answer your questions via email.'
    },
    {
      role: 'Design',
      description: 'Crafting intuitive, accessible interfaces that make security simple for everyone.'
    }
  ];
        ...
        <div style={{
          ...
          <div style={{
            ...
            {[
              ...
              { number: 'Zero', label: 'Knowledge Architecture' },
              { number: '24h', label: 'Max File Retention' },
              { number: '0', label: 'Plaintext Stored' }
            ].map((stat, index) => (
              <div key={index}>
                <div style={{
                  fontSize: '3rem',
